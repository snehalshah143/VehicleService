...
public class EmployeeController {
    ...
    public ResponseEntity<?> employeeSignUp(@RequestBody EmployeeSignUpRequest request, BindingResult bindingResult) {
    	   ...
    	   EmployeePersistable emp=EmployeeMappers.getEmployeeMappers().mapSignUpRequestToPersistable(request);
       ...
       if (bindingResult.hasErrors()) {
        ...
        EmployeeJsonDto jsonDto=EmployeeMappers.getEmployeeMappers().mapPersistableToJsonDto(empPersistable);
        
    	UserDetails userDetails = employeeDetailsService

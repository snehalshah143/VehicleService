...
public class UserVehicleDetailPersistable extends AbstractPerstistable {
  ...
  @GeneratedValue(
      ...
      generator = "vehicle_details_sequence_generator")
  @SequenceGenerator(
      name = "vehicle_details_sequence_generator",
      sequenceName = "vehicle_details_seq")
  ...
  */
  ...
  public UserVehicleDetailPersistable(
      ...
      @NotBlank String society,
      @NotBlank String locality,
      @NotBlank String parkingPlace,
      @NotBlank String pincode,
      @NotBlank String vehicleNumber,
      @NotBlank String manufacturingCompanyAndModel,

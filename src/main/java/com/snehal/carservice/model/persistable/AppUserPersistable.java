...
public class AppUserPersistable extends AbstractPerstistable {
  ...
  //    private Set <UserVehicleDetailPersistable> vehicleDetails = new
  // HashSet<UserVehicleDetailPersistable>();
  ...
  public AppUserPersistable(
      String mobileNumber, String password, String email, String firstName, String lastName) {
    super();

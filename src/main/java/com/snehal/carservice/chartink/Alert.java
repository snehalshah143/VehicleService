package com.snehal.carservice.chartink;
...
public Long getAlertId() {
	...
	public Alert(String stocks, String triggerPrices, String triggerdAt, String scanName, String scanUrl,
			String alertName) {
		super();
		this.stocks = stocks;
		this.triggerPrices = triggerPrices;
	...
	public String toString() {
		return "Alert [stocks=" + stocks + ", triggerPrices=" + triggerPrices + ", triggerdAt=" + triggerdAt
				+ ", scanName=" + scanName + ", scanUrl=" + scanUrl + ", alertName=" + alertName + "]";
	}

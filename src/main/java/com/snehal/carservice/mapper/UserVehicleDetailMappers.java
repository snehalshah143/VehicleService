...
public class UserVehicleDetailMappers
    extends AbstarctMapper<
        UserVehicleDetailJsonDto, UserVehicleDetail, UserVehicleDetailPersistable> {
  ...
  public UserVehicleDetailJsonDto mapPersistableToJsonDto(
      UserVehicleDetailPersistable persistable) {
    ...
    userVehicleDetailJsonDto.setVehicle(
        VehicleMappers.getVehicleMappers().mapPersistableToJsonDto(persistable.getVehicle()));
